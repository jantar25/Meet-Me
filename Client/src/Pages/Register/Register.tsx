...
const date1 = require("../../images/date2.png")
...
<div className='h-screen flex justify-center items-center overflow-hidden'>
        <div className='flex flex-col justify-center items-center p-4'>
            <div className='flex flex-col justify-center items-center'>
                ...
                <p className='text-gray-500 text-md mt-2 italic'>Registor and find your soulmate</p>
            </div>
            <div className='max-w-[200px] m-1'>
                <img src={date1} alt='date2' className='w-full'/>
            </div>
